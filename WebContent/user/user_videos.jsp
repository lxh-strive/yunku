...
<body>
	<div class="base">
		...
		<div>
			...
			<div>
				<ul class="user_navi" id="user_navi">
					...
					<li class="tag_select" data-url="#">我的视频</li>
		...
		<div class="middle">
			发布视频<input type="image"
				src="${applicationScope.basePath }img/send.png" title="发布视屏"
				onclick="sendVideo()" />
		</div>
		<div class="bottom">
	...
	<script type="text/javascript">
		...
		function sendVideo() {
			var url = "${applicationScope.basePath }video/video_pub.jsp";
			window.open(url, "video_pub");
		}
	</script>
</body>
</body>
