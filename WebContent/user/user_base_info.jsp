	...
	<div class="base">
		...
		<div>
			...
			<div>
				<ul class="user_navi" id="user_navi">
					<li class="tag_select" data-url="#">基本信息</li>
					<li class="tag"
		...
		<div class="middle">
			<ul style="padding-left: 0px">
				<li style="float: none;">邮箱:${sessionScope.user.email }</li>
				<li style="float: none; margin-top: 15px">用户名:${empty sessionScope.user.username?"未设置":sessionScope.user.username }</li>
				<li style="float: none; margin-top: 15px">手机:${empty sessionScope.user.mobile?"未绑定":sessionScope.user.mobile }</li>
				<li style="float: none; margin-top: 15px">头像: <c:choose>
						<c:when test="${empty sessionScope.user.pic}">未设置</c:when>
						<c:otherwise>
